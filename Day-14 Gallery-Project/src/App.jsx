...
let printUserData = <h3 className='text-gray-300 font-medium absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>Loading....</h3>;
if(userdata.length > 0){
  ...
  return (
    ...
    <div className='flex justify-center items-center gap-4 p-4'>
      ...
      <h4>Page {index}</h4>
      <button className='bg-amber-400 text-black font-bold text-xs cursor-pointer active:scale-95  rounded-full px-4 py-2'
      onClick={()=>{
        setUserData([])
        setIndex(index+1)
